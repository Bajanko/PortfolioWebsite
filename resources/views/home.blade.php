...
@section('content')
    ...
    <div class="flex flex-col md:flex-row items-center justify-between py-16">
        <div class="w-full md:w-1/2 mb-10 md:mb-0">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-800 dark:text-white leading-tight mb-4">
            ...
            <div class="flex space-x-4">
                <!-- Social Media Icons -->
                <a href="https://www.facebook.com/bajanko.jaiteh" target="_blank" rel="noopener noreferrer" class="w-12 h-12 flex items-center justify-center rounded-full bg-[#1d4ed8] hover:bg-blue-700 text-white transition duration-300" aria-label="Facebook">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                    </svg>
                </a>
                <a href="https://x.com/bajankojaiteh" target="_blank" rel="noopener noreferrer" class="w-12 h-12 flex items-center justify-center rounded-full bg-[#1d4ed8] hover:bg-blue-700 text-white transition duration-300" aria-label="Twitter">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                    </svg>
                </a>
                <a href="https://www.linkedin.com/in/janko-jaiteh-000872199/" target="_blank" rel="noopener noreferrer" class="w-12 h-12 flex items-center justify-center rounded-full bg-[#1d4ed8] hover:bg-blue-700 text-white transition duration-300" aria-label="LinkedIn">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/>
                    </svg>
                </a>
                <a href="https://github.com/Bajanko" target="_blank" rel="noopener noreferrer" class="w-12 h-12 flex items-center justify-center rounded-full bg-[#1d4ed8] hover:bg-blue-700 text-white transition duration-300" aria-label="GitHub">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="p-6 rounded-lg shadow-md bg-white dark:bg-gray-800 hover:shadow-lg transition duration-300">
                ...
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">Web Development</h3>
                <p class="text-gray-600 dark:text-gray-300">Building responsive, modern websites and applications with cutting-edge technologies.</p>
            </div>
            <div class="p-6 rounded-lg shadow-md bg-white dark:bg-gray-800 hover:shadow-lg transition duration-300">
                <div class="text-[#1d4ed8] dark:text-blue-400 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <h3 class="text-xl font-semibold mb-2 text-gray-800 dark:text-white">UI/UX Design</h3>
                <p class="text-gray-600 dark:text-gray-300">Creating beautiful, intuitive user interfaces that enhance the user experience.</p>
            </div>
            <div class="p-6 rounded-lg shadow-md bg-white dark:bg-gray-800 hover:shadow-lg transition duration-300">
                <div class="text-[#1d4ed8] dark:text-blue-400 mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p class="text-gray-600 dark:text-gray-300">Building robust server-side applications with secure, scalable architectures.</p>
            </div>
        </div>
    </div>
    ...
    <!-- Contact CTA -->
    <div class="py-12">
        <div class="bg-[#1d4ed8] dark:bg-blue-600 rounded-lg p-8 text-center">
            <h2 class="text-2xl md:text-3xl font-bold text-white mb-4">Interested in working together?</h2>
            <p class="text-blue-100 mb-6 max-w-2xl mx-auto">I'm always open to discussing new projects, creative ideas or opportunities to be part of your visions.</p>
