<nav class="bg-white dark:bg-gray-800 shadow-md fixed w-full z-10">
    ...
    <div id="mobile-menu" class="hidden md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a href="/" class="{{ request()->is('/') || request()->is('') ? 'text-primary-light dark:text-primary' : 'text-gray-700 dark:text-gray-300 hover:text-primary-dark dark:hover:text-primary hover:bg-indigo-50 dark:hover:bg-gray-700' }} block px-3 py-2 rounded-md text-base font-medium">Home</a>
