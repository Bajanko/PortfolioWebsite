    ...
    <div class="py-14">
        <div class="max-w-6xl  px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl md:text-4xl font-bold text-gray-800 dark:text-white mb-4 text-center">
                Lets get in <span class="text-[#1d4ed8] dark:text-blue-400">Touch</span>
            </h1>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6" style="min-height: 300px;">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="flex space-x-4">
                                <!-- GitHub -->
                                <a href="https://github.com/Bajanko" target="_blank" rel="noopener noreferrer" class="p-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition duration-300">
                                ...
                                <!-- LinkedIn -->
                                <a href="https://www.linkedin.com/in/janko-jaiteh-000872199/" target="_blank" rel="noopener noreferrer" class="p-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Twitter -->
                                <a href="https://x.com/bajankojaiteh" target="_blank" rel="noopener noreferrer" class="p-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <!-- Instagram -->
                                <a href="https://www.instagram.com/bajanko_jaiteh/" target="_blank" rel="noopener noreferrer" class="p-3 bg-gray-100 dark:bg-gray-700 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600 transition duration-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-700 dark:text-gray-300" fill="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/bajankojaiteh/Herd/PortfolioWebsite-production/resources/views/contact.blade.php ENDPATH**/ ?>