                ...
                <div id="projects-slider" class="flex transition-transform duration-500 ease-in-out">
                    ...
                    <div class="project-slide w-full flex-shrink-0">
                        <div class="relative h-[450px]">
                            <img src="<?php echo e(asset('images/q.png')); ?>" alt="Featured Project 1" class="w-full h-full object-cover">
                    ...
                    <div class="project-slide w-full flex-shrink-0">
                        <div class="relative h-[450px]">
                            <img src="<?php echo e(asset('images/cal3.png')); ?>" alt="Featured Project 2" class="w-full h-full object-cover">
                            <div class="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent">
                                <div class="absolute bottom-0 left-0 p-8 w-full">
                                    <span class="bg-[#1d4ed8] text-white px-3 py-1 rounded-full text-sm font-medium mb-4 inline-block">Web App</span>
                    ...
                    <div class="project-slide w-full flex-shrink-0">
                        <div class="relative h-[450px]">
                            <img src="<?php echo e(asset('images/pp.png')); ?>" alt="Featured Project 3" class="w-full h-full object-cover">
                            <div class="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent">
                                <div class="absolute bottom-0 left-0 p-8 w-full">
                                    <span class="bg-[#1d4ed8] text-white px-3 py-1 rounded-full text-sm font-medium mb-4 inline-block">Web App</span>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                ...
                <div class="project-card group" data-category="web">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:-translate-y-2">
                        <div class="relative h-60 overflow-hidden">
                            <img src="<?php echo e(asset('images/cal2.png')); ?>" alt="Project 1" class="w-full h-full object-cover transition duration-300 group-hover:scale-105">
                ...
                <div class="project-card group" data-category="ecommerce">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:-translate-y-2">
                        <div class="relative h-60 overflow-hidden">
                            <img src="<?php echo e(asset('images/rr.png')); ?>" alt="Project 2" class="w-full h-full object-cover transition duration-300 group-hover:scale-105">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 flex items-end">
                                <div class="p-4">
                                    <div class="flex flex-wrap gap-2 mb-4">
                                        <span class="px-2 py-1 bg-[#e0e7ff] text-[#1d4ed8] dark:bg-gray-700 dark:text-blue-400 rounded-md text-xs font-medium">Html</span>
                ...
                <div class="project-card group" data-category="mobile">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:-translate-y-2">
                        <div class="relative h-60 overflow-hidden ">
                            <img src="<?php echo e(asset('images/2.jpeg')); ?>" alt="Project 3" class="w-full h-full  py-4 object-cover transition duration-300 group-hover:scale-105">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 flex items-end">
                                <div class="p-4">
                ...
                <div class="project-card group" data-category="web">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:-translate-y-2 py-3">
                        <div class="relative h-60 overflow-hidden">
                            <img src="<?php echo e(asset('images/q.png')); ?>" alt="Project 4" class="w-full h-full object-cover transition duration-300 group-hover:scale-105">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 flex items-end">
                                <div class="p-4">
                                    <div class="flex flex-wrap gap-2 mb-4">
                                        <span class="px-2 py-1 bg-[#e0e7ff] text-[#1d4ed8] dark:bg-gray-700 dark:text-blue-400 rounded-md text-xs font-medium">HTML </span>
...
<?php echo $__env->make('main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/bajankojaiteh/Herd/PortfolioWebsite-production/resources/views/projects.blade.php ENDPATH**/ ?>